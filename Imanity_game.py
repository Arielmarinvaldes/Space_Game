# Mi juego en python for Ariel Marín Valdés: 2023
...
fondo = pygame.image.load('imagenes/Fondo_espacio.png')
laser_sonido = pygame.mixer.Sound('lacer_song.wav')
explosion_sonido = pygame.mixer.Sound('explotion.wav')
...
pygame.display.set_caption('Invation to Earth')
run = True
fps = 60
...
class Jugador(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		self.image = pygame.image.load('imagenes/nave_player.png').convert_alpha()
...
class Enemigos(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('imagenes/nave_enemy.png').convert_alpha()
		self.rect = self.image.get_rect()
...
class Balas(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('imagenes/bala_palyer.png').convert_alpha()
		self.rect = self.image.get_rect()
		self.rect.centerx = x
		self.rect.y = y
		self.velocidad = -18
...
class Balas_enemigos(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('imagenes/bala_enemy.png').convert_alpha()
